...
<div class="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
  ...
  <div class="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
    <img class="w-full" alt="image of a girl posing" src="http://localhost:5000/Images/A03I7114_1634797130_520x%20(1).webp" />
  ...
  <div class="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
    <div class="border-b border-gray-200 pb-6">
      <p class="text-sm leading-none text-gray-600 dark:text-gray-300 ">Dresses</p>
      <h1 class="lg:text-2xl text-xl font-semibold lg:leading-6 leading-7 text-gray-800 dark:text-white mt-2">The "Sunrise Soiree" Maxi Dress</h1>
    </div>
    ...
    <div>
      <p class="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 dark:text-gray-300 mt-7">Step into Fabulo's Boutique, a vibrant haven where fashion meets fun. We're not just about clothes, we're about celebrating your unique style. Our curated collection is a kaleidoscope of bold statement pieces and whimsical everyday finds, waiting to be woven into your own personal story.</p>
      <p class="text-base leading-4 mt-7 text-gray-600 dark:text-gray-300">Sun-kissed dresses that twirl with the breeze.</p>
      <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Graphic tees that speak your truth.</p>
      <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Cozy knits that hug you like a warm hug.</p>
      <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Denim that's as timeless as your favorite song.</p>
    </div>
    <br></br>
    <a href='/buynow'>
